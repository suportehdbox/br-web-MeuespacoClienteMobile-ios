...
class NewAccidentView: UIView {
    ...
    @objc public init(frame: CGRect, allowPHS: Bool, loggedInUser: Bool) {
        ...
        addSubview(btFooterHelp)

        btFooterHelp.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 20).isActive = true
        btFooterHelp.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -20).isActive = true
        ...
        if #available(iOS 11.0, *) {
            ...
            btFooterHelp.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -10).isActive = true
        }
    ...
    func createTitles(allowPHS: Bool) {
        ...
        lblTitle.topAnchor.constraint(equalTo: topAnchor, constant: 25).isActive = true
        ...
        lblSubTitle.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 20).isActive = true
        lblSubTitle.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -20).isActive = true
    ...
    func createButtons(allowPHS: Bool, loggedInUser: Bool) {
        ...
        stackView.heightAnchor.constraint(lessThanOrEqualTo: widthAnchor, multiplier: 0.35).isActive = true
        ...
        if allowPHS {
            ...
            addSubview(stackViewSec)
            stackViewSec.axis = .horizontal
            stackViewSec.alignment = .center
            stackViewSec.distribution = .fillProportionally

            stackViewSec.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 20).isActive = true
            stackViewSec.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -20).isActive = true
            stackViewSec.heightAnchor.constraint(lessThanOrEqualTo: widthAnchor, multiplier: 0.35).isActive = true
        ...
        btGlassAssist.setWidthConstraint(constant: bt24Assist.currentImage?.size.width ?? 300.0)
        btGlassAssist.setHeightConstraint(constant: bt24Assist.currentImage?.size.height ?? 300.0)
        ...
        baseView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 0).isActive = true
        baseView.trailingAnchor.constraint(equalTo: trailingAnchor, constant: 0).isActive = true
        baseView.topAnchor.constraint(equalTo: stackViewSec.bottomAnchor, constant: 10).isActive = true
        baseView.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -50).isActive = true
