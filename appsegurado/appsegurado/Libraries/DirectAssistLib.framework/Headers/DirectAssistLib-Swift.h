...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DirectAssistLib",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15DirectAssistLib26DirectAssistViewController")
@interface DirectAssistViewController : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC15DirectAssistLib22CallHelpViewController")
@interface CallHelpViewController : DirectAssistViewController
- (void)viewDidLoad;
...
@interface CallHelpViewController (SWIFT_EXTENSION(DirectAssistLib)) <UITextFieldDelegate>
...
SWIFT_CLASS("_TtC15DirectAssistLib18CaseViewController")
@interface CaseViewController : DirectAssistViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC15DirectAssistLib25LiveHelpMapViewController")
@interface LiveHelpMapViewController : DirectAssistViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface LiveHelpMapViewController (SWIFT_EXTENSION(DirectAssistLib)) <GMSMapViewDelegate>
@end


SWIFT_CLASS("_TtC15DirectAssistLib21LoadingViewController")
...
SWIFT_CLASS("_TtC15DirectAssistLib25LocationMapViewController")
@interface LocationMapViewController : DirectAssistViewController <CLLocationManagerDelegate>
- (void)viewDidLoad;
...
@interface LocationMapViewController (SWIFT_EXTENSION(DirectAssistLib)) <GMSMapViewDelegate>
...
SWIFT_CLASS("_TtC15DirectAssistLib28LocationSearchViewController")
@interface LocationSearchViewController : DirectAssistViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface LocationSearchViewController (SWIFT_EXTENSION(DirectAssistLib)) <UISearchBarDelegate>
...
@interface LocationSearchViewController (SWIFT_EXTENSION(DirectAssistLib)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC15DirectAssistLib21MyCasesViewController")
@interface MyCasesViewController : DirectAssistViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface MyCasesViewController (SWIFT_EXTENSION(DirectAssistLib)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC15DirectAssistLib13NibDesignable")
...
SWIFT_CLASS("_TtC15DirectAssistLib35NibDesignableCollectionReusableView")
...
SWIFT_CLASS("_TtC15DirectAssistLib31NibDesignableCollectionViewCell")
...
SWIFT_CLASS("_TtC15DirectAssistLib20NibDesignableControl")
...
SWIFT_CLASS("_TtC15DirectAssistLib26NibDesignableTableViewCell")
...
SWIFT_CLASS("_TtC15DirectAssistLib38NibDesignableTableViewHeaderFooterView")
...
SWIFT_CLASS("_TtC15DirectAssistLib15SessionDelegate")
...
@property (nonatomic, copy) void (^ _Nullable sessionDidBecomeInvalidWithError)(NSURLSession * _Nonnull, NSError * _Nullable) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.sessionDidBecomeInvalidWithError' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
@property (nonatomic, copy) void (^ _Nullable sessionDidReceiveChallengeWithCompletion)(NSURLSession * _Nonnull, NSURLAuthenticationChallenge * _Nonnull, void (^ _Nonnull)(enum NSURLSessionAuthChallengeDisposition, NSURLCredential * _Nullable)) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.sessionDidReceiveChallengeWithCompletion' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Overrides default behavior for URLSessionDelegate method <code>urlSessionDidFinishEvents(forBackgroundURLSession:)</code>.
@property (nonatomic, copy) void (^ _Nullable sessionDidFinishEventsForBackgroundURLSession)(NSURLSession * _Nonnull) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.sessionDidFinishEventsForBackgroundURLSession' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
@property (nonatomic, copy) NSURLRequest * _Nullable (^ _Nullable taskWillPerformHTTPRedirection)(NSURLSession * _Nonnull, NSURLSessionTask * _Nonnull, NSHTTPURLResponse * _Nonnull, NSURLRequest * _Nonnull) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.taskWillPerformHTTPRedirection' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
@property (nonatomic, copy) void (^ _Nullable taskWillPerformHTTPRedirectionWithCompletion)(NSURLSession * _Nonnull, NSURLSessionTask * _Nonnull, NSHTTPURLResponse * _Nonnull, NSURLRequest * _Nonnull, void (^ _Nonnull)(NSURLRequest * _Nullable)) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.taskWillPerformHTTPRedirectionWithCompletion' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Overrides all behavior for URLSessionTaskDelegate method <code>urlSession(_:task:didReceive:completionHandler:)</code> and
/// requires the caller to call the <code>completionHandler</code>.
@property (nonatomic, copy) void (^ _Nullable taskDidReceiveChallengeWithCompletion)(NSURLSession * _Nonnull, NSURLSessionTask * _Nonnull, NSURLAuthenticationChallenge * _Nonnull, void (^ _Nonnull)(enum NSURLSessionAuthChallengeDisposition, NSURLCredential * _Nullable)) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.taskDidReceiveChallengeWithCompletion' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Overrides default behavior for URLSessionTaskDelegate method <code>urlSession(_:task:needNewBodyStream:)</code>.
@property (nonatomic, copy) NSInputStream * _Nullable (^ _Nullable taskNeedNewBodyStream)(NSURLSession * _Nonnull, NSURLSessionTask * _Nonnull) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.taskNeedNewBodyStream' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Overrides all behavior for URLSessionTaskDelegate method <code>urlSession(_:task:needNewBodyStream:)</code> and
/// requires the caller to call the <code>completionHandler</code>.
@property (nonatomic, copy) void (^ _Nullable taskNeedNewBodyStreamWithCompletion)(NSURLSession * _Nonnull, NSURLSessionTask * _Nonnull, void (^ _Nonnull)(NSInputStream * _Nullable)) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.taskNeedNewBodyStreamWithCompletion' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
@property (nonatomic, copy) void (^ _Nullable taskDidSendBodyData)(NSURLSession * _Nonnull, NSURLSessionTask * _Nonnull, int64_t, int64_t, int64_t) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.taskDidSendBodyData' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Overrides default behavior for URLSessionTaskDelegate method <code>urlSession(_:task:didCompleteWithError:)</code>.
@property (nonatomic, copy) void (^ _Nullable taskDidComplete)(NSURLSession * _Nonnull, NSURLSessionTask * _Nonnull, NSError * _Nullable) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.taskDidComplete' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
@property (nonatomic, copy) enum NSURLSessionResponseDisposition (^ _Nullable dataTaskDidReceiveResponse)(NSURLSession * _Nonnull, NSURLSessionDataTask * _Nonnull, NSURLResponse * _Nonnull) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.dataTaskDidReceiveResponse' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
@property (nonatomic, copy) void (^ _Nullable dataTaskDidReceiveResponseWithCompletion)(NSURLSession * _Nonnull, NSURLSessionDataTask * _Nonnull, NSURLResponse * _Nonnull, void (^ _Nonnull)(enum NSURLSessionResponseDisposition)) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.dataTaskDidReceiveResponseWithCompletion' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Overrides default behavior for URLSessionDataDelegate method <code>urlSession(_:dataTask:didBecome:)</code>.
@property (nonatomic, copy) void (^ _Nullable dataTaskDidBecomeDownloadTask)(NSURLSession * _Nonnull, NSURLSessionDataTask * _Nonnull, NSURLSessionDownloadTask * _Nonnull) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.dataTaskDidBecomeDownloadTask' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Overrides default behavior for URLSessionDataDelegate method <code>urlSession(_:dataTask:didReceive:)</code>.
@property (nonatomic, copy) void (^ _Nullable dataTaskDidReceiveData)(NSURLSession * _Nonnull, NSURLSessionDataTask * _Nonnull, NSData * _Nonnull) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.dataTaskDidReceiveData' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
@property (nonatomic, copy) NSCachedURLResponse * _Nullable (^ _Nullable dataTaskWillCacheResponse)(NSURLSession * _Nonnull, NSURLSessionDataTask * _Nonnull, NSCachedURLResponse * _Nonnull) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.dataTaskWillCacheResponse' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
/// requires caller to call the <code>completionHandler</code>.
@property (nonatomic, copy) void (^ _Nullable dataTaskWillCacheResponseWithCompletion)(NSURLSession * _Nonnull, NSURLSessionDataTask * _Nonnull, NSCachedURLResponse * _Nonnull, void (^ _Nonnull)(NSCachedURLResponse * _Nullable)) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.dataTaskWillCacheResponseWithCompletion' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
@property (nonatomic, copy) void (^ _Nullable downloadTaskDidFinishDownloadingToURL)(NSURLSession * _Nonnull, NSURLSessionDownloadTask * _Nonnull, NSURL * _Nonnull) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.downloadTaskDidFinishDownloadingToURL' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
@property (nonatomic, copy) void (^ _Nullable downloadTaskDidWriteData)(NSURLSession * _Nonnull, NSURLSessionDownloadTask * _Nonnull, int64_t, int64_t, int64_t) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.downloadTaskDidWriteData' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
@property (nonatomic, copy) void (^ _Nullable downloadTaskDidResumeAtOffset)(NSURLSession * _Nonnull, NSURLSessionDownloadTask * _Nonnull, int64_t, int64_t) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.downloadTaskDidResumeAtOffset' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Overrides default behavior for URLSessionStreamDelegate method <code>urlSession(_:readClosedFor:)</code>.
@property (nonatomic, copy) void (^ _Nullable streamTaskReadClosed)(NSURLSession * _Nonnull, NSURLSessionStreamTask * _Nonnull) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.streamTaskReadClosed' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint") SWIFT_AVAILABILITY(tvos,introduced=9.0) SWIFT_AVAILABILITY(macos,introduced=10.11) SWIFT_AVAILABILITY(ios,introduced=9.0);
/// Overrides default behavior for URLSessionStreamDelegate method <code>urlSession(_:writeClosedFor:)</code>.
@property (nonatomic, copy) void (^ _Nullable streamTaskWriteClosed)(NSURLSession * _Nonnull, NSURLSessionStreamTask * _Nonnull) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.streamTaskWriteClosed' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint") SWIFT_AVAILABILITY(tvos,introduced=9.0) SWIFT_AVAILABILITY(macos,introduced=10.11) SWIFT_AVAILABILITY(ios,introduced=9.0);
/// Overrides default behavior for URLSessionStreamDelegate method <code>urlSession(_:betterRouteDiscoveredFor:)</code>.
@property (nonatomic, copy) void (^ _Nullable streamTaskBetterRouteDiscovered)(NSURLSession * _Nonnull, NSURLSessionStreamTask * _Nonnull) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.streamTaskBetterRouteDiscovered' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint") SWIFT_AVAILABILITY(tvos,introduced=9.0) SWIFT_AVAILABILITY(macos,introduced=10.11) SWIFT_AVAILABILITY(ios,introduced=9.0);
/// Overrides default behavior for URLSessionStreamDelegate method <code>urlSession(_:streamTask:didBecome:outputStream:)</code>.
@property (nonatomic, copy) void (^ _Nullable streamTaskDidBecomeInputAndOutputStreams)(NSURLSession * _Nonnull, NSURLSessionStreamTask * _Nonnull, NSInputStream * _Nonnull, NSOutputStream * _Nonnull) SWIFT_DEPRECATED_OBJC("Swift property 'SessionDelegate.streamTaskDidBecomeInputAndOutputStreams' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint") SWIFT_AVAILABILITY(tvos,introduced=9.0) SWIFT_AVAILABILITY(macos,introduced=10.11) SWIFT_AVAILABILITY(ios,introduced=9.0);
...
@interface SessionDelegate (SWIFT_EXTENSION(DirectAssistLib)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(DirectAssistLib)) <NSURLSessionDelegate>
...
SWIFT_AVAILABILITY(tvos,introduced=9.0) SWIFT_AVAILABILITY(macos,introduced=10.11) SWIFT_AVAILABILITY(ios,introduced=9.0)
@interface SessionDelegate (SWIFT_EXTENSION(DirectAssistLib)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(DirectAssistLib)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(DirectAssistLib)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC15DirectAssistLib12TaskDelegate")
@interface TaskDelegate : NSObject
/// The serial operation queue used to execute all operations after the task completes.
@property (nonatomic, readonly, strong) NSOperationQueue * _Nonnull queue SWIFT_DEPRECATED_OBJC("Swift property 'TaskDelegate.queue' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// The data returned by the server.
@property (nonatomic, readonly, copy) NSData * _Nullable data SWIFT_DEPRECATED_OBJC("Swift property 'TaskDelegate.data' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// The error generated throughout the lifecyle of the task.
@property (nonatomic) NSError * _Nullable error SWIFT_DEPRECATED_OBJC("Swift property 'TaskDelegate.error' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
@interface UIView (SWIFT_EXTENSION(DirectAssistLib))
@property (nonatomic, readonly, strong) UIView * _Nonnull nibContainerView;
/// Called in the default implementation of loadNib(). Default is class name.
///
/// returns:
/// Name of a single view nib file.
- (NSString * _Nonnull)nibName SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'UIView.nibName()' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@end
