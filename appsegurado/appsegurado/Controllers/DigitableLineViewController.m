...
-(void) returnPaymentLine:(DigitableLineBeans *)beans{
    ...
    if([beans.summaryInstructions isEqualToString:@""]){
        ...
        //venceu boleto
        [view setTitle:NSLocalizedString(@"TituloBoletoVencido", @"") instructions:NSLocalizedString(@"SubTituloBoletoVencido", @"") summaryInstructions:beans.summaryInstructions linecode:beans.digitableLine completeInstructions:beans.completeInstructions];
        [view setBtSantander];
    }
