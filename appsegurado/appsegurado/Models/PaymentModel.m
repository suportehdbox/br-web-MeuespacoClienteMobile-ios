...
-(void) getInstallmentPaymentLine:(int)installment contract:(long)contract issuance:(int)issuance{
    ...
    conn = [[Conexao alloc] initWithURL:[NSString stringWithFormat:@"%@Segurado/Seguro/GetDigitableLine",[super getBaseUrl:@"v2"]] contentType:@"application/x-www-form-urlencoded"];
